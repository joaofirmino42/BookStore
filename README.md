...
### `npm i`
This command installs the dependencies/libraries, described in the file `package.json`
### `npm start`
...
Navigate to the directory containing the Dockerfile in the terminal and its application files and
...
```
```
$ docker run -d -p 8080:80 name_of_your_image
```
Once running, to access the front-end, simply open [http://localhost:8080/#/](http://localhost:8080/#/) in the browser.
